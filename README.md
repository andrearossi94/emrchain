...
hurl invoke cartellaclinica cartellaclinica_create "{\"name\":\"my first request\",\"id\":\"0001\",\"created\":0,\"modified\":0}"
```
...
npm run cc:package -- cartellaclinica org1
# Install to your blockchain - From the root of your project
hurl install cartellaclinica node -P ./chaincode-cartellaclinica
# Install in debug mode, this will run the chaincode server locally so you can debug
hurl install cartellaclinica node -P ./chaincode-cartellaclinica --debug

# Upgrade your existing chaincode - From the root of your project
hurl upgrade cartellaclinica node 1.2 -P ./chaincode-cartellaclinica
```
...
# Upgrade your existing chaincode - From the root of your project
npm run cc:upgrade -- cartellaclinica 1.2
```
